...
class OrsayCrawlSpider(CrawlSpider):
    ...
    def parse_pagination(self, response):
        ...
        for x in [response.follow(url_s, callback=self.parse_product) for url_s in urls_s]:
            yield x
        ...
        if products_found > self.page_size:
            ...
            yield [Request(add_or_replace_parameter(response.url, 'sz', page * self.page_size),
